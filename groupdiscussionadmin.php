...
$(document).ready(function()
 ...
 {
      $("#result").load("load_discussion.php").show();// a function which will load data from other file after x seconds
  }
...
function post()
{
  ...
  return false;
		...
		<a href="/dir/task/admin/index.php"><button class="btn"><i class="fa fa-chevron-circle-left" aria-hidden="true"></i>&nbsp;Home &nbsp;<?php echo $user; ?></button></a>
